  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Medicate <span className="legal-siteSign">+</span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Medicate Plus, your trusted online Medicare platform. Our
          mission is to provide accessible and personalized Medicare services
        ...
        <p className="legal-description">
          When using Medi Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Medi Plus is designed to simplify Medicare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2024-2027 Medi+. All rights reserved.</p>
      </div>
    </div>
  );
}
